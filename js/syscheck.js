...
function sysCheck() {
  ...
  if (browserStr == "Chrome") { //Chrome is supported, but it is recommended to disable the bookmarks bar.
    ...
    debugConsole += "User is using either Chrome or a Chromium-based browser, width will be 1903, and displaying bookmarks bar notice.\n";
    ...
    debugConsole += "User is using Firefox, width will be 1920.\n";
    width = "1920";
    ...
    debugConsole += "User is using Opera, width will be 1903, and game borders will not be drawn.\n";
    bmbarNote.style.position = "static";
    bmbarNote.style.fontSize = "13px";
    ...
    debugConsole += "User is using Edge, width will be 1897, numbers will not be formatted, and game borders will not be drawn.\n";
    bmbarNote.style.position = "static";
    bmbarNote.style.fontSize = "13px";
...
function resolutionCheck(width) { //There are currently only two supported resolutions, 1920x1080, and 1366x768. A different stylesheet is loaded based on browser width. It is recommended that you play the game in a maximized browser window at default zoom (100%).
  ...
  if ($(window).width() > width || $(window).width() < "1366" || $(window).width() > "1366" && $(window).width() < width) {
    ...
    debugConsole += "WARN: User has an unsupported window width. The window or zoom size may have changed, or their resolution is lower than supported. Using fallback for now.\n";
